...
describe('step = MariaDB servers and databases', () => {
  ...
  it('should collect an Azure Diagnostic Log Settings entity', () => {
    ...
    expect(collectedEntities).toContainEqual(
      expect.objectContaining({
        id: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/logs/MySqlSlowLogs/true/1/true`,
        _key: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/logs/MySqlSlowLogs/true/1/true`,
        _class: MonitorEntities.DIAGNOSTIC_LOG_SETTING._class,
        _type: MonitorEntities.DIAGNOSTIC_LOG_SETTING._type,
        category: 'MySqlSlowLogs',
        displayName: 'j1dev_mariadb_diag_set',
        enabled: true,
        ...
        webLink: `https://portal.azure.com/#@www.fake-domain.com/resource/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set`,
        workspaceId: null,
      }),
    );
  });

  it('should collect an Azure MariaDB Server has Azure Diagnostic Log Settings relationship', () => {
    const { collectedRelationships } = context.jobState;
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _key: `/subscriptions/${instanceConfig.subscriptionId}/resourceGroups/j1dev/providers/Microsoft.DBforMariaDB/servers/j1dev-mariadb-server|has|/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/logs/MySqlSlowLogs/true/1/true`,
      _toEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/logs/MySqlSlowLogs/true/1/true`,
      displayName:
        MonitorRelationships.AZURE_RESOURCE_HAS_MONITOR_DIAGNOSTIC_LOG_SETTING
          ._class,
    });
  ...
  it('should collect an Azure Diagnostic Log Settings uses Azure Storage Account relationship', () => {
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _fromEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/logs/MySqlSlowLogs/true/1/true`,
  ...
  it('should collect an Azure Diagnostic Log Settings entity', () => {
    ...
    expect(collectedEntities).toContainEqual(
      expect.objectContaining({
        id: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/logs/MySqlAuditLogs/true/1/true`,
        _key: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/logs/MySqlAuditLogs/true/1/true`,
        _class: MonitorEntities.DIAGNOSTIC_LOG_SETTING._class,
        _type: MonitorEntities.DIAGNOSTIC_LOG_SETTING._type,
  ...
  it('should collect an Azure MariaDB Server has Azure Diagnostic Log Settings relationship', () => {
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _toEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/logs/MySqlAuditLogs/true/1/true`,
      displayName:
        MonitorRelationships.AZURE_RESOURCE_HAS_MONITOR_DIAGNOSTIC_LOG_SETTING
          ._class,
    });
  ...
  it('should collect an Azure Diagnostic Log Settings uses Azure Storage Account relationship', () => {
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _type:
        MonitorRelationships.DIAGNOSTIC_LOG_SETTING_USES_STORAGE_ACCOUNT._type,
      _fromEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/logs/MySqlAuditLogs/true/1/true`,
  ...
  it('should collect an Azure Diagnostic Metric Settings entity', () => {
    ...
    expect(collectedEntities).toContainEqual(
      expect.objectContaining({
        id: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/metrics/AllMetrics/true/undefined/1/true`,
        _key: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/metrics/AllMetrics/true/undefined/1/true`,
  ...
  it('should collect an Azure MariaDB Server has Azure Diagnostic Metric Settings relationship', () => {
    const { collectedRelationships } = context.jobState;
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _toEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/metrics/AllMetrics/true/undefined/1/true`,
      displayName:
        MonitorRelationships
          .AZURE_RESOURCE_HAS_MONITOR_DIAGNOSTIC_METRIC_SETTING._class,
    });
  ...
  it('should collect an Azure Diagnostic Metric Settings uses Azure Storage Account relationship', () => {
    const { collectedRelationships } = context.jobState;
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _type:
        MonitorRelationships.DIAGNOSTIC_METRIC_SETTING_USES_STORAGE_ACCOUNT
          ._type,
      _fromEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformariadb/servers/j1dev-mariadb-server/providers/microsoft.insights/diagnosticSettings/j1dev_mariadb_diag_set/metrics/AllMetrics/true/undefined/1/true`,
