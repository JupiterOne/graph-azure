...
export const eventHubStep: AzureIntegrationStep[] = [
  {
    ...
    rolePermissions: ['Microsoft.EventHub/namespaces/read'],
  ...
  },
  {
    ...
    rolePermissions: ['Microsoft.EventHub/namespaces/eventhubs/read'],
  ...
  },
  {
    ...
    relationships: [],
    dependsOn: [STEP_AD_ACCOUNT],
    rolePermissions: ['Microsoft.EventHub/clusters/read'],
