import { createGroupMemberRelationships } from "./GroupMemberRelationshipConverter";

test("convert group has user relationships", async () => {
  const members = [
    {
  ...
  expect(relationshipss).toEqual([
    {
      ...
      _key:
        "azure_user_group_89fac263-2430-48fd-9278-dacfdfc89792_has_azure_user_324e8daa-9c29-42a4-a74b-b9893e6d9750",
    ...
    },
    {
      ...
      _fromEntityKey: "azure_user_group_89fac263-2430-48fd-9278-dacfdfc89792",
      _key:
        "azure_user_group_89fac263-2430-48fd-9278-dacfdfc89792_has_azure_user_group_89fac263-2430-48fd-9278-dacfdfc89792",
