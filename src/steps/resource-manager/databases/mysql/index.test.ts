...
describe('step = MySQL servers and databases', () => {
  ...
  it('should collect an Azure Diagnostic Log Setting entity', () => {
    ...
    expect(collectedEntities).toContainEqual(
      expect.objectContaining({
        id: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlSlowLogs/true/1/true`,
        _key: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlSlowLogs/true/1/true`,
        _class: MonitorEntities.DIAGNOSTIC_LOG_SETTING._class,
        _type: MonitorEntities.DIAGNOSTIC_LOG_SETTING._type,
        category: 'MySqlSlowLogs',
        displayName: 'j1dev_mysql_diag_set',
        enabled: true,
        ...
        webLink: `https://portal.azure.com/#@www.fake-domain.com/resource/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set`,
        workspaceId: null,
      }),
    );
  });

  it('should collect an Azure MySQL Server has Azure Diagnostic Log Setting relationship', () => {
    const { collectedRelationships } = context.jobState;
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _key: `/subscriptions/${instanceConfig.subscriptionId}/resourceGroups/j1dev/providers/Microsoft.DBforMySQL/servers/j1dev-mysqlserver|has|/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlSlowLogs/true/1/true`,
      _toEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlSlowLogs/true/1/true`,
      displayName:
        MonitorRelationships.AZURE_RESOURCE_HAS_MONITOR_DIAGNOSTIC_LOG_SETTING
          ._class,
    });
  ...
  it('should collect an Azure Diagnostic Log Setting uses Azure Storage Account relationship', () => {
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _fromEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlSlowLogs/true/1/true`,
      _key: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlSlowLogs/true/1/true|uses|/subscriptions/${instanceConfig.subscriptionId}/resourceGroups/j1dev/providers/Microsoft.Storage/storageAccounts/${instanceConfig.developerId}j1dev`,
  ...
  it('should collect an Azure Diagnostic Log Setting entity', () => {
    ...
    expect(collectedEntities).toContainEqual(
      expect.objectContaining({
        id: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlAuditLogs/true/1/true`,
        _key: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlAuditLogs/true/1/true`,
        _class: MonitorEntities.DIAGNOSTIC_LOG_SETTING._class,
        _type: MonitorEntities.DIAGNOSTIC_LOG_SETTING._type,
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _type:
        MonitorRelationships.AZURE_RESOURCE_HAS_MONITOR_DIAGNOSTIC_LOG_SETTING
          ._type,
      _fromEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourceGroups/j1dev/providers/Microsoft.DBforMySQL/servers/j1dev-mysqlserver`,
      _key: `/subscriptions/${instanceConfig.subscriptionId}/resourceGroups/j1dev/providers/Microsoft.DBforMySQL/servers/j1dev-mysqlserver|has|/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlAuditLogs/true/1/true`,
      _toEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlAuditLogs/true/1/true`,
      displayName:
        MonitorRelationships.AZURE_RESOURCE_HAS_MONITOR_DIAGNOSTIC_LOG_SETTING
          ._class,
    });
  ...
  it('should collect an Azure Diagnostic Log Setting uses Azure Storage Account relationship', () => {
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _type:
        MonitorRelationships.DIAGNOSTIC_LOG_SETTING_USES_STORAGE_ACCOUNT._type,
      _fromEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlAuditLogs/true/1/true`,
      _key: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/logs/MySqlAuditLogs/true/1/true|uses|/subscriptions/${instanceConfig.subscriptionId}/resourceGroups/j1dev/providers/Microsoft.Storage/storageAccounts/${instanceConfig.developerId}j1dev`,
      _toEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourceGroups/j1dev/providers/Microsoft.Storage/storageAccounts/${instanceConfig.developerId}j1dev`,
      displayName:
        MonitorRelationships.DIAGNOSTIC_LOG_SETTING_USES_STORAGE_ACCOUNT._class,
    });
  ...
  it('should collect an Azure Diagnostic Metric Setting entity', () => {
    ...
    expect(collectedEntities).toContainEqual(
      expect.objectContaining({
        id: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/metrics/AllMetrics/true/undefined/1/true`,
        _key: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/metrics/AllMetrics/true/undefined/1/true`,
  ...
  it('should collect an Azure MySQL Server has Azure Diagnostic Metric Setting relationship', () => {
    const { collectedRelationships } = context.jobState;
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _toEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/metrics/AllMetrics/true/undefined/1/true`,
      displayName:
        MonitorRelationships
          .AZURE_RESOURCE_HAS_MONITOR_DIAGNOSTIC_METRIC_SETTING._class,
    });
  ...
  it('should collect an Azure Diagnostic Metric Setting uses Azure Storage Account relationship', () => {
    ...
    expect(collectedRelationships).toContainEqual({
      ...
      _type:
        MonitorRelationships.DIAGNOSTIC_METRIC_SETTING_USES_STORAGE_ACCOUNT
          ._type,
      _fromEntityKey: `/subscriptions/${instanceConfig.subscriptionId}/resourcegroups/j1dev/providers/microsoft.dbformysql/servers/j1dev-mysqlserver/providers/microsoft.insights/diagnosticSettings/j1dev_mysql_diag_set/metrics/AllMetrics/true/undefined/1/true`,
