...
test(
  ...
  async () => {
    ...
    recording = setupAzureRecording({
      name: STEP_ACCESS_PACKAGE_CATALOG,
      directory: __dirname,
      options: {
        recordFailedRequests: true,
        matchRequestsBy: getMatchRequestsBy({
...
test(
  STEP_AZURE_APPLICATION,
  async () => {
    const stepTestConfig = getStepTestConfigForStep(STEP_AZURE_APPLICATION);
...
test(
  ...
  async () => {
    ...
    recording = setupAzureRecording({
      name: STEP_AZURE_APPLICATION_ASSIGNED_TO_ACCESS_PACKAGE_CATALOG_RELATIONSHIP,
      directory: __dirname,
      options: {
        recordFailedRequests: true,
        matchRequestsBy: getMatchRequestsBy({
